...
const div = num1 / num2
console.log(`A soma de ${num1} com ${num2} dá = ${soma}`)
console.log(`A subtração de ${num1} com ${num2} dá = ${sub}`)
console.log(`A multiplicação de ${num1} com ${num2} dá = ${mult}`)
console.log(`A divisão de ${num1} com ${num2} dá = ${div}`)
...
const var1 = parseFloat(prompt("Digite aqui a sua primeira nota: "))
const var2 = parseFloat(prompt("Digite aqui a sua segunda nota: "))
const var3 = parseFloat(prompt("Digite aqui a sua terceira nota: "))
...
const valoro = prompt("Qual é o valor original do produto?: ")
const porcentagem = prompt("Qual é a porcentagem do desconto?: ")
const valorfinal = valoro - ((porcentagem / 100) * 100 ) 
...
console.log(`De R$: ${valor} convertido em dolar dá: ${dolarformatado}`)
 ...
 const celsius = prompt("Digite aqui o valor celsius: ")
...
const peso = prompt("Digite aqui o peso em kg: ")
const altura = prompt("Digite aqui a altura em metros: ")
